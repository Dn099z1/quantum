...
function LamarScreen({ setLamar }) {
  ...
  return (
    <S.Container>
      <S.Logo src="https://media.discordapp.net/attachments/1059878373737893918/1125947172165255178/quantum_small.png?width=988&height=346" />
      <S.Content>
        <S.Title>
          Seja bem-vindo(a) à <b>quantum City</b>!<br />
        </S.Title>
        <S.Description>
        ...
        <S.Button onClick={handleCloseLamarScreen}>Continuar!</S.Button>
        <S.Button onClick={handleCloseLamarScreen}>NÃO! Esqueça isso!</S.Button>
      </S.Content>
    </S.Container>
  );
}
