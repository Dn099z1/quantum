...
export const ItemImage = styled.img`
  ...
  max-height: 40px; // Tamanho máximo da imagem
  object-fit: contain;  // Redimensiona a imagem mantendo a proporção
  object-position: center; // Garante que a imagem se centralize no espaço disponível
`;
