...
function Production({ data }) {
  ...
  return (
    <S.Container>
      <S.Logo src="https://media.discordapp.net/attachments/1059878373737893918/1118607399503286362/quantum_small.png?width=405&height=141" />
      <S.Content>
        <S.ProductList>
          {Object.keys(data.products)
            ...
            .map((item) => (
              <S.Product key={item} onClick={() => handleSelectProduct(item)}>
                <S.ProductImage
                  src={`https://hosting-nine-lime.vercel.app/files/itens/${item}.png`}
                />
          ...
          {product.name ? (
            <S.Form>
              ...
              <S.HeaderProduction className="p-item">
                <S.ProductionImage
                  src={`https://hosting-nine-lime.vercel.app/files/itens/${productIndex}.png`}
                />
                <S.Description>
