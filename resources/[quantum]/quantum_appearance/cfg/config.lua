                ...
                male = {
                    torso = {
                        tattoo = {
                            ...
                            { name = 'mp_nyo_peito_lobo_001_M', part = 'nyo_overlays' }, 
                            { name = 'mp_nyo_peito_lobo_010_M', part = 'nyo_overlays' }, 
                            { name = 'mp_nyo_peito_lobo_005_M', part = 'nyo_overlays' },  
                            { name = 'mp_nyo_costas_lobo_003_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_costas_lobo_004_M', part = 'nyo_overlays' },  
                            { name = 'mp_nyo_costas_lobo_007_M', part = 'nyo_overlays' },  

                            { name = 'mp_nyo_costas_dragao_001_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_costas_dragao_003_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_costas_dragao_002_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_costas_dragao_006_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_costas_dragao_007_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_costas_dragao_008_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_costas_dragao_009_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_dragao_005_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_dragao_007_M', part = 'nyo_overlays' },
                        }
                    },
                    head = {
                        tattoo = {
                    ...
                    leftarm = {
                        tattoo = {
                            ...
                            { name = 'mp_nyo_braco_esquerdo_lobo_006_M', part = 'nyo_overlays' },
                    ...
                    rightarm = {
                        tattoo = {
                            ...
                            { name = 'MP_nyo_teste_001_M', part = 'nyo_overlays' },

                            { name = 'mp_nyo_braco_direito_lobo_002_M', part = 'nyo_overlays' },
                            { name = 'mp_nyo_braco_direito_lobo_009_M', part = 'nyo_overlays' },  

                            { name = 'mp_nyo_braco_direito_dragao_006_M', part = 'nyo_overlays' },
                        }
                    },
                    leftleg = {
                        tattoo = {
                    ...
                    rightleg = {
                        tattoo = {
                            ...
                            { name = 'mp_nyo_perna_direita_lobo_008_M', part = 'nyo_overlays' },
                        }
                    },
                    overlay = {
                        tattoo = {
                ...
                female = {
                    torso = {
                        tattoo = {
                            ...
                            { name = 'mp_nyo_peito_seios_001_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_002_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_003_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_004_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_005_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_006_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_007_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_008_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_009_F', part = 'nyo_overlays' },
                            { name = 'mp_nyo_peito_seios_010_F', part = 'nyo_overlays' },
                        }
                    },
                    head = {
                        tattoo = {
...
config.locs = {
    -- [ Skin Shop ] --
    { blip = true, coord = vector4(71.81538, -1398.989, 29.36414-0.97, 269.2914), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(429.7582, -800.2813, 29.48206-0.97, 85.03937), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(123.3363, -228.0791, 54.55457-0.97, 342.9921), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(-164.4132, -311.5648, 39.72668-0.97, 328.8189), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(-829.8066, -1073.433, 11.31799-0.97, 206.9291), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(-715.5956, -146.7165, 37.40149-0.97, 198.4252), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(-1188.224, -765.3758, 17.31653-0.97, 124.7244), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(-1446.04, -230.1758, 49.80298-0.97, 127.5591), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(-3173.591, 1038.923, 20.85498-0.97, 337.3228), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(-1109.051, 2709.758, 19.10254-0.97, 223.937), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(614.5055, 2768.334, 42.08569-0.97, 175.748), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(1190.624, 2714.492, 38.21021-0.97, 175.748), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(1697.341, 4829.684, 42.052-0.97, 93.5433), config = 'all', type = 'skinshop' },
    { blip = true, coord = vector4(12.40879, 6513.547, 31.87476-0.97, 34.01575), config = 'all', type = 'skinshop' },

    -- [ Barber Shop ] --
    { blip = true, coord = vector4(-813.9297, -182.756, 37.5531-0.97, 206.9291), config = 'all', type = 'barbershop' },
    { blip = true, coord = vector4(-1282.787, -1117.78, 6.987549-0.97, 357.1653), config = 'all', type = 'barbershop' },
    { blip = true, coord = vector4(1932.224, 3730.483, 32.83521-0.97, 113.3858), config = 'all', type = 'barbershop' },
    { blip = true, coord = vector4(1212.277, -473.4725, 66.19775-0.97, 345.8268), config = 'all', type = 'barbershop' },
    ...
    { blip = true, coord = vector4(322.7077, 180.0923, 103.5707-0.97, 79.37008), config = 'all', type = 'tattooshop' },
