...
local setGender = function(gender) 
    ...
    local weapons = (quantum.getWeapons() or {})
...
cli.createCharacter = function()
    ...
    TriggerEvent('quantum_weather:staticTime', { 
        weather = 'EXTRASUNNY', 
        hours = 14, 
        minutes = 0 
    })
    ...
    quantum.teleport(generalConfig.creatorLocation.xyz)
...
finishCreator = function()
    ...
    TriggerEvent('quantum_weather:staticTime', false)
    Citizen.Wait(1000)
    DoScreenFadeOut(500)
    SetEntityHealth(ped, 200)
