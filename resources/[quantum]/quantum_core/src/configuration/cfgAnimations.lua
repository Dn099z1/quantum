...
config.animations = {
    ['keyMapping'] = {
            ...
            action = function()
                ...
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not cancelKeyMapping) then
                    if (IsEntityPlayingAnim(ped, 'anim@heists@heist_corona@single_team', 'single_team_loop_boss', 3)) then
                        quantum.DeletarObjeto()
                    else
                        quantum.DeletarObjeto()
                        quantum.playAnim(true, {{ 'anim@heists@heist_corona@single_team', 'single_team_loop_boss' }}, true)
                    end
                end
            end
        },
        ['aguardar'] = {
            ...
            action = function()
                local ped = PlayerPedId()
                local menuCelular = quantum.getMenuCelular()
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    if (IsEntityPlayingAnim(ped, 'mini@strip_club@idles@bouncer@base', 'base', 3)) then
                        ...
                        quantum.DeletarObjeto()
                        quantum.playAnim(true, {{ 'mini@strip_club@idles@bouncer@base', 'base' }}, true)
                    end
                end
            end
        },
            ...
            action = function()
                ...
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    if (IsEntityPlayingAnim(ped, 'anim@mp_player_intselfiethe_bird', 'idle_a', 3)) then
                        ...
                        quantum.DeletarObjeto()
                        quantum.playAnim(true, {{ 'anim@mp_player_intselfiethe_bird', 'idle_a' }}, true)
                    end
                end
            end
        },
            ...
            action = function()
                ...
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    if IsEntityPlayingAnim(ped, 'random@arrests@busted', 'idle_a', 3) then
                        ...
                        quantum.DeletarObjeto()
                        quantum.CarregarAnim('random@arrests')
                        quantum.CarregarAnim('random@arrests@busted')
        ...
        ['cancelar'] = {
            ...
            action = function()
                local ped = PlayerPedId()
                local menuCelular = quantum.getMenuCelular()
                TriggerEvent('quantum_animations:cancelSharedAnimation')
                TriggerEvent('quantum:CancelAnimations')
            ...
            action = function()
                ...
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    if IsEntityPlayingAnim(ped, 'random@arrests@busted', 'idle_a', 3) then
                        ...
                        quantum.DeletarObjeto()
                        quantum.playAnim(true, {{'random@arrests@busted', 'idle_a'}}, true)    
                    end            
                end
            end
        },
            ...
            action = function()
                ...
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    if IsEntityPlayingAnim(ped, 'random@mugging3', 'handsup_standing_base', 3) then
                        ...
                        quantum.DeletarObjeto()
                        quantum.playAnim(true, {{'random@mugging3', 'handsup_standing_base'}}, true)
                    end
                end
            end
        },
        ['delete'] = {
            ...
            action = function()
                ...
                local menuCelular = quantum.getMenuCelular()
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    quantum.playAnim(true, {{ 'anim@mp_player_intincarthumbs_upbodhi@ps@', 'enter' }}, false)
                end
            end
        },
        ['assobiar'] = {
            ...
            action = function()
                ...
                local menuCelular = quantum.getMenuCelular()
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    quantum.playAnim(true, {{ 'rcmnigel1c', 'hailing_whistle_waive_a' }}, false)
                end
            end
        },
        ['saudacao'] = {
            ...
            action = function()
                ...
                local menuCelular = quantum.getMenuCelular()
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    quantum.playAnim(true, {{ 'anim@mp_player_intcelebrationmale@salute', 'salute' }}, false)
                end
            end
        },
        ['joia'] = {
            ...
            action = function()
                ...
                local menuCelular = quantum.getMenuCelular()
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    quantum.playAnim(true, {{ 'anim@mp_player_intselfiethumbs_up', 'idle_a' }}, false)
                end
            end
        },
        ['facepalm'] = {
            ...
            action = function()
                ...
                local menuCelular = quantum.getMenuCelular()
                if (not IsPedInAnyVehicle(ped) and GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    quantum.playAnim(true, {{ 'anim@mp_player_intupperface_palm', 'idle_a' }}, false)
                end
            end
        },
        ['apontar'] = {
            ...
            action = function()
                ...
                if (GetEntityHealth(ped) > 100 and not menuCelular and not cancelKeyMapping) then
                    quantum.CarregarAnim('anim@mp_point')
        ...
        ['deitar9'] = {
            ...
            loop = true 
                ...
                ['camera2'] = { 
                    ...
                    hand = 28422,
                    extra = function()
                       TriggerEvent('animationsEvent', 'camera2', true)
                    end
                },
                ['gift'] = { 
                    ...
                    andar = false, 
                    extra = function()
                        quantum._CarregarObjeto('', '', 'genesisxmasgift', 49, 57005, 0.10, 0.0, -0.02, 180.0, 0.0, 0.0)
                    end
                },
                ['gift2'] = { 
                    dict = 'genesismods@gift', 
                    ...
                    andar = false, 
                    extra = function()
                        quantum._CarregarObjeto('', '', 'genesisxmasgift2', 49, 57005, 0.10, 0.0, -0.02, 180.0, 0.0, 0.0)
                    end
                },
                ['prancheta'] = { 
                ...
                ['dancar234'] = { 
                    dict = 'move_clown@p_m_quantum_idles@',
                    anim = 'fidget_short_dance', 
                    andar = false, 
                    loop = true 
                },
                ...
                ['binoculos'] = { 
                    ...
                    hand = 28422, 
                    extra = function()
                        TriggerEvent('animationsEvent', 'binoculos', true)
                    end 
                },
                ...
                ['bong'] = {
                    ...
                    extra = function()
                        if not IsPedInAnyVehicle(PlayerPedId()) then
                            ...
                            TriggerEvent('quantum_sound:source','bong',0.5)
                            SetTimeout(8700,function()
                                quantum.DeletarObjeto()
                                ShakeGameplayCam('SMALL_EXPLOSION_SHAKE',0.5)
                            end)
                            SetTimeout(9000,function()
                                quantum.loadAnimSet('MOVE_M@DRUNK@VERYDRUNK')
                ...
                ['pano'] = {
                    ...
                    hand = 28422,
                    extra = function()
                        local vehicle = quantum.getNearestVehicle(7)
    ...
    ['walkAnim'] = {
        ...
        { anim = 'move_m@hobo@a' },
        { anim = 'move_f@hurry@a' },
        { anim = 'move_p_m_quantum_janitor' },
        { anim = 'move_p_m_quantum_slow' },
        { anim = 'move_m@jog@' },
