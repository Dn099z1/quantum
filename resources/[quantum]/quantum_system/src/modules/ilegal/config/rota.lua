Routes = {
    ...
    locations = {
        ...
        { coord = vector3(-1855.332, -1204.009, 13.00293), config = 'quantumFome', cooldown = 300, perm = 'quantumfome.permissao' },
        ...
        { coord = vector3(146.611, -3007.859, 7.038086), config = 'Mecanica', cooldown = 300, perm = 'quantummecanica.permissao' },
