...
local sourceVerification = function(source)
    ...
    if (source == 0) then 
        ...
        allow = quantum.hasPermission(quantum.getUserId(source), '+Staff.COO')
    end
    return allow 
end
...
local generateWeather = function()
    ...
    if (weathersConfig[weatherRandom].active) then
        ...
        print('Clima da cidade ^5New Valley^7 alterado para ^5'..GlobalState.weather..'^7.')
    end
end
...
RegisterCommand('time', function(source, args)
    ...
    if (allow) then
        if (args[1]) then
            ...
            print('Tempo da cidade ^5New Valley^7 alterado para ^5'..GlobalState.hours..':'..GlobalState.minutes..'^7.')
        end
    end
end)
...
RegisterCommand('freezetime', function(source)
    ...
    if (allow) then
        ...
        print('Tempo da cidade ^5New Valley^7 foi ^5'..(freezetime == true and 'congelado' or 'descongelado')..'^7.')
    end
end)
