...
SetPlayerInMaca = function(index)
    ...
    TriggerEvent('quantum_animations:setAnim', _config.anim)
end
...
AddEventHandler('quantum:CancelAnimations',function()
...
RegisterNetEvent('quantum_macas:reanimar', function(time)
