                                ...
                                Citizen.CreateThread(function()
                                    ...
                                    while (isFueling) do
                                        ...
                                        if (currentFuel >= 100) then
                                            exports.quantum_fuel:SetFuel(VehToNet(vehicle), 100.0)
        ...
        Citizen.CreateThread(function()
            while (LocalPlayer.state.Prison) do
                ...
                if (not inside) then
                    ...
                    quantum.teleport(1753.358, 2470.998, 47.39343)
                end
                Citizen.Wait(1500)
            end
        end)
            ...
            while (LocalPlayer.state.Prison) do
                ...
                if (inside) then
                    ...
                    if (IsControlJustPressed(0, 38) and not workout) then
                        ...
                        LocalPlayer.state.BlockTasks = true
                        FreezeEntityPosition(ped, true)
                        TriggerEvent('quantum_animations:setAnim', 'malhar')
        ...
        Citizen.CreateThread(function()
            ...
            while (LocalPlayer.state.Asylum) do
                ...
                if (not inside) then
                    ...
                    quantum.teleport(-110.6769, 7488.092, 5.808105)
                end
                Citizen.Wait(1500)
            end
