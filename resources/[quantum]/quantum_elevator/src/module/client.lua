    ...
    Citizen.CreateThread(function()
        while (countTable(nearestBlips) > 0) do
            ...
            for index, dist in pairs(_cache) do
				...
				DrawMarker(27, _config.coord.x, _config.coord.y, _config.coord.z, 0, 0, 0, 0, 0, 0, 1.2, 1.2, 1.2, 0, 235, 216, 52, 0, 0, 0, 1)
...
RegisterNUICallback('elevatorFloor', function(data, cb)
	...
	Citizen.Wait(1000)
	TriggerEvent('quantum_sound:source', 'elevator-bell', 0.3)
	SetNuiFocus(false, false)
	DoScreenFadeIn(1000)
