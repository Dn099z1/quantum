...
$(document).ready(() => {
  ...
  $(document).on("click", ".clear", function () {
    $.post(`http://quantum_arsenal/clear`, "[]");
  });
  ...
  $(document).on("click", ".arma-equipar", function () {
    $.post(
      `http://quantum_arsenal/equipar-arma`,
  ...
  $(document).on("click", ".utilitario-equipar", function () {
    $.post(
      `http://quantum_arsenal/equipar-utilitario`,
      JSON.stringify({ selectUtilitary })
    );
  });

  $(document).on("click", ".kit-equipar", function () {
    $.post(`http://quantum_arsenal/equipar-kit`, JSON.stringify({ selectKits }));
  });
  ...
  $(document).on("click", ".attachs", function () {
    $.post(`http://quantum_arsenal/attachs`, "[]");
  });

  $(document).on("click", ".treino", function () {
    $.post(`http://quantum_arsenal/treino`, "[]");
    closeNUI();
  });
  ...
  const closeNUI = () => {
    $("#arsenal").fadeOut();
    $("#arsenal #arsenal-notify .wrap").html("");
    $.post("http://quantum_arsenal/close", "[]");
  };
