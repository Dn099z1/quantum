...
quantum.getCustomPlayer = function()
    local ped = PlayerPedId()
...
quantum.addBlip = function(x, y, z, idtype, idcolor, text, scale, route)
...
quantum.removeBlip = function(id)
	RemoveBlip(id)
end

quantum.setGPS = function(x, y)
