quantum.getMenuCelular = function()
	return menu_celular
end
...
quantum.loadAnimSet = function(dict)
	RequestAnimSet(dict)
	while not HasAnimSetLoaded(dict) do Citizen.Wait(10) end
	SetPedMovementClipset(PlayerPedId(), dict, 0.25)
end

quantum.CarregarAnim = function(dict)
	RequestAnimDict(dict)
	while not HasAnimDictLoaded(dict) do Citizen.Wait(10) end
end

quantum.CarregarObjeto = function(dict, anim, prop, flag, hand, pos1, pos2, pos3, pos4, pos5, pos6, anim2)
...
quantum.DeletarObjeto = function(id)
