...
config.general = {
    ...
    ['ammu'] = {
        ...
        ['weapon_flashlight'] = {
            name = 'Lanterna', index = 'weapon_flashlight',
            price = {
                buy = 1500
            },
            method = 'legal'
        ...
        ['weapon_crowbar'] = {
            name = 'Pé De Cabra', index = 'weapon_crowbar',
            price = {
                buy = 1500
            },
            method = 'legal'
        ...
        ['weapon_knuckle'] = {
            name = 'Soco Ingles', index = 'weapon_knuckle',
            price = {
                buy = 1500
            },
            method = 'legal'
        ...
        ['weapon_hatchet'] = {
            name = 'Machado', index = 'weapon_hatchet',
            price = {
                buy = 1500
            },
            method = 'legal'
        ...
        ['weapon_switchblade'] = {
            name = 'Canivete', index = 'weapon_switchblade',
            price = {
                buy = 1500
            },
            method = 'legal'
...
config.shops = {
    ...
    { name = 'quantum Fome', type = 'buy', coord = vector3(-1836.738, -1184.083, 14.30042), config = 'quantumfome' },
}