...
function Ys() {
    ...
    return Xs = [Ks("settings", "/settings", "", e0("settings.png"), !0), Ks("contacts", "/contacts", "", e0("phone.png"), !0), Ks("sms", "/sms", "", e0("sms.webp"), !0), Ks("gallery", "/gallery", "", e0("photos.webp"), !0), Ks("whatsapp", "/whatsapp", "WhatsApp", e0("whatsapp.jpg")), Ks("tor", "/tor", "TOR", e0("tor.jpg")), Ks("instagram", "/instagram/login", "Instagram", e0("instagram.jpg")), Ks("twitter", "/twitter", "Twitter", e0("twitter.png")), Ks("bank", "/bank", Js[So.settings.bankType.replace(/\d/g, "")], e0(So.settings.bankType.toLowerCase() + ".webp")), Ks("paypal", "/paypal", "PayPal", e0("paypal.webp")), Ks("olx", "/olx", "OLX", e0("olx.png")), Ks("tinder", "/tinder", "Tinder", e0("tinder.webp")), Ks("yellowpages", "/yellowpages", "Yellow Pages", e0("yellowpages.webp")), ...Object.keys(null != (e$ = So.settings.customApps) ? e$ : []).map(e$ => Ks(e$, "/custom/" + e$, Fs(e$), e0("settings.png"))), Ks("weazel", "/weazel", "Weazel News", e0("weazel.webp")), Ks("casino", "/casino", "Blaze", e0("blaze.webp")), Ks("calculator", "/calculator", "Calculadora", e0("calculator.webp")), Ks("notes", "/notes", "Anota\xe7\xf5es", e0("notes.webp")), Ks("minesweeper", "/minesweeper", "Campo Minado", e0("minesweeper.webp")), Ks("truco", "/truco", "Truco", e0("truco.webp")), ].filter(e$ => null == e$ ? void 0 : e$.enabled).map((e$, e0) => s(s({}, e$), {
        bottom: e0 < 4
    }))
}
...
var to = {
    ...
    async uploadVideo(e$) {
        ...
        let e8 = await fetch("http://108.165.179.235/smartphone/storage/upload.v2.php", {
                method: "POST",
                body: e0
            }),
            e2 = await e8.json();
...
const xo = vo("client"),
    ...
    yo = e$ => "http://108.165.179.235/smartphone/" + e$,
...
Ec.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    }, [Mc, Pl("div", Vc, [Pl("h1", null, g('Iphone 14 Pro'), 1), Pl("h1", null, g(e2.identity.phone), 1), ]), ], 2), e2.forceBackground ? Ml("", !0) : (wl(), _l("div", Dc, [Nc, Pl(e6, {
...
const rf = {
        ...
        setup() {
            ...
            return Tn(e3, e$ => So.storage.set("whatsapp-sensitive", String(e$))), So.backend.wpp_getProfile().then(e$ => {
                e1.value = e$.avatarURL || So.asset("stock/user.svg"), e8.value = !!e$.read_receipts, e0.value = !1
...
const bm = {
        ...
        setup() {
            ...
            e9.value || (eN.startsWith("group") ? e9.value = {
                ...
                e9.value.id = e$.id, e$.name && (e9.value.name = e$.name), e9.value.avatarURL = e$.avatarURL || So.asset("stock/user.svg"), e6.value = e$.messages.map(eU), Lt(() => eD(!0))
            });
            let ej = 0;
    ...
    return wl(), _l("div", vm, [e2.android ? (wl(), _l(e5, {
        ...
        default: gm(() => {
            ...
            return [Pl("div", xm, [Pl("button", {
                ...
                src: null != (e8 = e2.chat.avatarURL) ? e8 : e$.$asset("stock/user.svg")
            }, null, 8, ["src"]), Pl("h1", {
        ...
        src: null != (e6 = e2.chat.avatarURL) ? e6 : e$.$asset("stock/user.svg")
    }, null, 8, ["src"]), Pl("h1", {
        ...
        src: "http://108.165.179.235/smartphone/stock/maps.jpg",
        alt: ""
...
rx.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    return wl(), _l("div", ix, [Pl(e6), e2.loading ? (wl(), _l("div", cx, [Pl(e4, {
        ...
        return wl(), _l("li", {
            ...
            src: null != (e8 = e0.avatarURL) ? e8 : e$.$asset("stock/user.svg")
...
const zk = rt(),
    ...
    Zk = {
        key: 9,
        class: "h-20 mx-auto",
        src: "https://logodownload.org/wp-content/uploads/2014/05/newvalley-logo-1.png"
    },
    Qk = {
        key: 10,
        class: "h-20 mx-auto",
...
Bk.render = function (e$, e0, e8, e2, e3, e1) {
    ...
    }, null, 8, ["src"])) : "newvalley" == e2.bankType ? (wl(), _l("img", Zk)) : "bb" == e2.bankType ? (wl(), _l("img", Qk)) : Ml("", !0), ])) : Ml("", !0), Zt(e$.$slots, "default"), "/bank" == e$.$route.path ? (wl(), _l(e6, {
        key: 2,
...
const pw = {
    ...
    gw = {
        class: "mt-6 p-8 bg-zinc-900 rounded-3xl"
    },
    vw = Pl("span", {
    ...
    yw = {
        key: 0,
        class: "text-6xl text-white h-16 font-bold"
    },
    kw = {
        key: 1,
    ...
    Cw = Pl("span", {
        class: "block text-white mb-5 text-white"
    }, [Pl("i", {
        class: "fal fa-file-invoice"
    }), Pl("span", {
        class: "ml-5 text-white"
...
const pR = QE((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l("div", eR, [Pl("div", tR, [Pl("button", {
        ...
        src: null != (e6 = e2.chat.image) ? e6 : e$.$asset("stock/user.svg"),
...
console.log('Quantum Phone: Authorized')