gbMembers = Tunnel.getInterface('core_ilegal/members')
gbGoals = Tunnel.getInterface('core_ilegal/goals')
gbMessage = Tunnel.getInterface('core_ilegal/message')
gbProduction = Tunnel.getInterface('core_ilegal/production')
